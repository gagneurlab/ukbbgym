...
PHENOTYPE_FILE="/s/project/geno2pheno/BFuncRVP/data/regenie/regenie_input/genebass_continuous_phenos.txt"
# PHENOTYPE_FILE="/s/project/geno2pheno/BFuncRVP/data/regenie/regenie_input/phenos_P2G_extended.txt"

# For Samples
SAMPLE_LIST="/s/project/geno2pheno/BFuncRVP/data/regenie/regenie_input/3rd_degree_unrelated_EUR_sample_500k.txt"
...
OUTPUT_DIR="/s/project/deeprvat/ukb_gym/regenie/"
...
# Temporary Directory
TEMP_DIR="/scratch/tmp/regenie_prs_tmp/"
