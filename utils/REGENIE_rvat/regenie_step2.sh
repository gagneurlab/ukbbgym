...
STEP1_PRED_FILE="/s/project/deeprvat/ukb_gym/regenie/quant_traits/prs.list_pred.list"
...
OUTPUT_DIR="/s/project/deeprvat/ukb_gym/regenie/quant_traits/rvat"
...
# Temporary Directory
TEMP_DIR="/scratch/tmp/regenie_rvat_tmp/"
