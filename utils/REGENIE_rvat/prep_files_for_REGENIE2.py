...
# scores_df = pl.read_parquet(os.environ["UKB_WES_ALPHAMISSENSE_SCORES_PATH"])
OUT_FOLDER = "PATH_TO_FILE"
scores_df = pl.read_parquet(os.environ["UKB_WES_PLOF_SCORES_PATH"])
cov_df = pl.read_parquet(os.environ["UKB_COVARIATES_PATH"], columns = ['individual'])
...
write_sample_file(sample_ids, OUT_FOLDER + "sample_bgen.sample")
write_bgen_from_scores(scores_df, gene_info_df, OUT_FOLDER + "scores_bgen.bgen")
