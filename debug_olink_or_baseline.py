...
olink_corrs = pl.read_parquet('/home/dnanexus/data_dir/olink_all_mac20_lofteeHC_correlations.parquet')
...
plt.tight_layout()
plt.savefig('/home/dnanexus/ukbgym/debug_olink_extreme_rates.png', dpi=150, bbox_inches='tight')
print("\n✓ Saved plot to: /home/dnanexus/ukbgym/debug_olink_extreme_rates.png")
